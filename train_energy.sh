...
# python preprocess_hubert_f0.py --in_dir dataset/${data_name} --f0_predictor dio
...
CUDA_VISIBLE_DEVICES=${ngpu} python train_energy.py -c configs/config_${data_name}.json -m ${data_name} -p ${port}