...
def train_and_evaluate(rank, epoch, hps, nets, optims, schedulers, scaler, loaders, logger, writers):
    ...
    for batch_idx, items in enumerate(train_loader):
        ...
        with autocast(enabled=hps.train.fp16_run):
            ...
            (z, z_p, m_p, logs_p, m_q, logs_q), pred_lf0, norm_lf0, lf0, predict_mel = net_g(c, f0, uv, spec, g=g, c_lengths=lengths,
        ...
        with autocast(enabled=hps.train.fp16_run):
            ...
            with autocast(enabled=False):
                ...
                loss_mel_am = F.mse_loss(mel, predict_mel)
                loss_gen_all = loss_gen + loss_fm + loss_mel + loss_kl + loss_lf0 + loss_mel_am
        optim_g.zero_grad()
